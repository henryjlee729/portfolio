...
emailjs.init('Avu_MykvAbEwi1X13');
...
const Contact = () => {
    ...
    const submitForm = () => {
        emailjs
            .sendForm(
                'service_rossk1x', 'template_wt712jg', form.current
            )
            .then(
                function (response) {
                    setSubmitted(true)
                ...
                <div className='grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5'>
                    <div className='lg:col-span-2'>
                        ...
                        <p className='max-w-xl text-lg pt-4'>
                            Have any questions? Send me a message! <br />
                            <br />
                            ...
                            <a
                                className='text-blue-500 hover:underline'
                                href='mailto:iwilldiscoveraurora@gmail.com'
                            >
                                iwilldiscoveraurora@gmail.com
                            </a>
                        </p>
                    </div>
                            ...
                            <div className='mt-4'>
                                {!submitted ? (
                                    ...
                                    <Popup
                                        ...
                                        message='If this error keeps occuring, please contact me directly through my email and/or LinkedIn.'
                                    />
                                )}
                            </div>
                        </form>
