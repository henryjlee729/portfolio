        ...
        <div className="max-w-5xl md:px-4 py-8 pb-32 mx-auto space-y-10">
          ...
          <section className="p-4 md:p-8 bg-gray-100 rounded-lg shadow-2xl">
            ...
            <div className="grid grid-cols-1 gap-0 sm:gap-8 md:grid-cols-3 items-center">
              ...
              <blockquote className="sm:col-span-2">
                <p className="text-xs md:text-base">
                  Orion, this is the world. The world, Orion. A former angel
          ...
          <section className="p-4 md:p-8 bg-gray-100 rounded-lg shadow-2xl">
            ...
            <div className="grid grid-cols-1 gap-0 sm:gap-8 md:grid-cols-3 items-center">
              ...
              <blockquote className="sm:col-span-2">
                <p className="text-xs md:text-base">
                  Zzz... Raella is a slacker who loves to sleep and do nothing.
                  She is like an immovable object. No matter what you do,
                  nothing can ever wake her up. Not even a car horn. How odd.
                  She isn't supposed to be sleeping for that long...
                </p>
              </blockquote>
            </div>
          </section>
